...
class Receiver(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.center_freq = center_freq = 425e6
        ...
        self.fcdproplus_fcdproplus_0.set_freq(99900000)
        self._center_freq_range = Range(1, 1e9, 1, 425e6, 200)
        ...
        self.connect((self.fcdproplus_fcdproplus_0, 0), (self.blocks_multiply_const_vxx_0_0, 0))
